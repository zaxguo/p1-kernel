...
// xzl: read&check header, then read program
int fce_load_rom(char *rom)
{
    ...
    static byte buf[1048576];       // xzl: another big buf
...
void fce_update_screen()        // xzl: called by ppu cycle
{
