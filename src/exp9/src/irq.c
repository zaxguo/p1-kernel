...
void enable_interrupt_controller()
{
    ...
    put32(PA2VA(TIMER_INT_CTRL_0), TIMER_INT_CTRL_0_VALUE);
    put32(PA2VA(ENABLE_IRQS_1), ENABLE_IRQS_1_USB | ENABLE_IRQS_1_AUX); 
...
void handle_irq(void) {
    ...
    unsigned int irq = get32(PA2VA(INT_SOURCE_0));
    switch (irq) {
